...
<div class="row white-bg page-heading">
    <div class="col-md-7">
        <h2>
            ...
            <?= $this->context->parent->lang->title ?>
        </h2>
        <?= Breadcrumbs::widget([
            'homeLink' => false,
            'links' => [
                ...
                [
                    'label' => $this->context->parent->lang->title,
                ],
                Yii::t('app', 'List'),
            ],
        ]) ?>
    ...
    <div class="col-md-2">
        <h2 class="btn-group" role="group">
            <?= Html::a(Yii::t('app', 'Предметы'), ['/catalog/types/list'], ['class' => 'btn btn-warning']) ?>
        </h2>
    </div>
    <div class="col-md-3">
        <h2 class="btn-group" role="group">
            <?= Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app', 'Create'), ['create', 'parent_id' => $this->context->parent->id], ['class' => 'btn btn-primary']) ?>
