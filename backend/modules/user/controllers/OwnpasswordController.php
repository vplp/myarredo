...
/**
 * Class OwnpasswordController
 *
 * @package admin\modules\user\controllers
 * @author FilamentV <vortex.filament@gmail.com>
 * @copyright (c), Thread
 */
class OwnpasswordController extends BackendController
{
    public $name = 'ownpassword';
    public $title = "User Password";
    public $label = "User Password";
    protected $model = User::class;
    public $actionListLinkStatus = ['/user/ownprofile/update'];
    ...
    public function init()
    {
        ...
        $this->actionListLinkStatus = ['/user/ownprofile/update', 'id' => Yii::$app->getUser()->id];
