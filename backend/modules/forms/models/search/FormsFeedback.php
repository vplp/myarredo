 ...
 */
class FormsFeedback extends FormsFeedbackModel implements BaseBackendSearchModel
{
    public $title;
    ...
    {
        $query = FormsFeedbackModel::findBase()->undeleted();
    ...
    {
        $query = FormsFeedbackModel::findBase()->deleted();
        return $this->baseSearch($query, $params);
    }
}
