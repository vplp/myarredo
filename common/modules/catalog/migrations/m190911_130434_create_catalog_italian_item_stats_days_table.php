...
/**
 * Handles the creation of table `{{%catalog_italian_item_stats_days}}`.
 */
class m190911_130434_create_catalog_italian_item_stats_days_table extends Migration
{
    /**
     * table name
     * @var string
     */
    public $table = '{{%catalog_italian_item_stats_days}}';
