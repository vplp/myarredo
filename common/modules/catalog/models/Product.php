...
class Product extends ActiveRecord implements iProduct
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'factory_price' => Yii::t('app', 'Factory price'), //'Цена фибрики',
            'price_from' => Yii::t('app', 'Price from'), //'Цена от',
            'removed' => 'Снят с производства',
            'in_stock' => 'Под заказ | В наличии',
            'factory_id' => Yii::t('app','Factory'),
            'collections_id' => Yii::t('app', 'Collections'), //'Коллекция',
            'catalog_type_id' => Yii::t('app', 'Catalog type'), //'Тип предмета',
            'popular' => 'Популярное',
            'user' => 'Кто изменил',
