...
/**
 * Handles the creation of table `{{%news_article_rel_city}}`.
 */
class m210715_154548_create_news_article_rel_city_table extends Migration
{
    /**
     * @var string
     */
    public $tableRel = '{{%news_article_rel_city}}';
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey(
            'fk-news_article_rel_city_ibfk_1',
            $this->tableRel,
            'article_id',
            $this->tableArticle,
            'id',
        ...
        $this->addForeignKey(
            'fk-news_article_rel_city_ibfk_2',
            $this->tableRel,
            'city_id',
            $this->tableCity,
            'id',
    ...
    {
        $this->dropForeignKey('fk-news_article_rel_city_ibfk_2', $this->tableRel);
        $this->dropForeignKey('fk-news_article_rel_city_ibfk_1', $this->tableRel);
