...
/**
 * Class m170901_163201_create_table_system_mail_carrier_lang
 *
 * @author FilamentV <vortex.filament@gmail.com>
 * @copyright (c), Thread
 */
class m170901_163201_create_table_system_mail_carrier_lang extends Migration
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public $tableLang = '{{%system_mail_carrier_lang}}';
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey(
            'fv_system_mail_carrier_lang_ibfk_1',
            $this->tableLang,
            'rid',
            $this->table,
            'id',
    ...
    {
        $this->dropForeignKey('fv_system_mail_carrier_lang_ibfk_1', $this->tableLang);
