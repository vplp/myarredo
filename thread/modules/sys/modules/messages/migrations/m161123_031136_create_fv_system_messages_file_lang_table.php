...
/**
 * Class m161123_031136_create_fv_system_messages_file_lang_table
 *
 * @author FilamentV <vortex.filament@gmail.com>
 * @copyright (c), Thread
 */
class m161123_031136_create_fv_system_messages_file_lang_table extends Migration
{
     ...
     * @var string
     */
    public $tableLang = '{{%system_messages_file_lang}}';
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey(
            'fk-system_messages_file-rid-menu-id',
            $this->tableLang,
            'rid',
            $this->table,
            'id',
    ...
    {
        $this->dropForeignKey('fk-system_messages_file-rid-menu-id', $this->tableLang);
