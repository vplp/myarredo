...
define('LANG_DIR_NAME', dirname(__DIR__, 1) . '/lang/');
...
if (!function_exists('trans')) {
    ...
    if (!isset($_SESSION['RF']['language'])
        || file_exists(LANG_DIR_NAME . basename($_SESSION['RF']['language']) . '.php') === false
        || !is_readable(LANG_DIR_NAME . basename($_SESSION['RF']['language']) . '.php')
    ) {
        ...
        if ($lang != $default_language) {
            ...
            $languages = include LANG_DIR_NAME . 'languages.php';
        }

        // add lang file to session for easy include
        $_SESSION['RF']['language'] = $lang;
    } else {
        if (file_exists(LANG_DIR_NAME . 'languages.php')) {
            $languages = include LANG_DIR_NAME . 'languages.php';
        }
    ...
    if (file_exists(LANG_DIR_NAME . $lang . '.php')) {
        $lang_vars = include LANG_DIR_NAME . $lang . '.php';
    }
