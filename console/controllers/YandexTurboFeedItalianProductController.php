...
use console\models\{ItalianProduct};

/**
 * Class YandexTurboFeedItalianProductController
 *
 * @package console\controllers
 */
class YandexTurboFeedItalianProductController extends Controller
{
    public $filePath = '@root/web/turbo-feed/italian-product/';
    ...
    public function actionCreate()
    {
        ...
        $offers = ItalianProduct::findBase()->all();
    ...
    {
        if ($offers) {
            $filePath = Yii::getAlias($this->filePath . '/turbo_feed_italian_product_' . $city['alias'] . '.xml');
            ...
            foreach ($offers as $offer) {
                /** @var $offer ItalianProduct */
                if (!empty($offer['category']) && ItalianProduct::isImage($offer['image_link']) && $offer['price_new'] > 0) {
                    ...
                    $str = "\t<offer id=\"" . $offer['id'] . "\">" . PHP_EOL .
                        ...
                        "\t\t<picture>" . ItalianProduct::getImageThumb($offer['image_link']) . "</picture>" . PHP_EOL;
