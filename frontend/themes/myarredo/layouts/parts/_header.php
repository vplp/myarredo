        ...
        <div class="bot-header">
            <div class="container large-container">
                ...
                <?php if (!Yii::$app->getUser()->isGuest && (
                    ...
                    <?php if ($this->beginCache('CatalogMenuWidget' . Yii::$app->city->getCityId(), ['duration' => 60 * 60 * 2])) {
                        echo CatalogMenu::widget([]);
                        $this->endCache();
                    } ?>

                    <div class="search-cont">
                        <?php if ($this->beginCache('ElasticSearch' . Yii::$app->city->getCityId(), ['duration' => 60 * 60 * 2])) {
...
<div class="mobile-header">
    ...
    <div class="mobmenu-serch-part">
        <?php
        if ($this->beginCache('ElasticSearchMobile' . Yii::$app->city->getCityId(), ['duration' => 60 * 60 * 2])) {
            $form = ActiveForm::begin([
                'action' => ['/catalog/elastic-search/search'],
    ...
    <div class="mobile-menu js-mobile-menu">
        ...
        if (
            ...
            echo UserMenu::widget(['view' => 'user_menu_mobile']);
            if ($this->beginCache('CatalogMenuMobileWidget' . Yii::$app->city->getCityId(), ['duration' => 60 * 60 * 2])) {
