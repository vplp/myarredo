...
<div style="width:540px; height: 700px; font: 16px Arial,sans-serif;">
    ...
    <div style="background-color:#fff9ea; text-align: left; padding: 10px 0 40px 10px;">
        ...
        <p style="font-size: 13px; color: #591612;">Согласно вашему запросу № <span style="font-weight: bold; color: #000;">№<?= $modelOrder['id'] ?></span> от <?= $modelOrder->getCreatedTime(); ?> года,
