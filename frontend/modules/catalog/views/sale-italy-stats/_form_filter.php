...
use frontend\modules\catalog\models\ItalianProductStatsDays;
...
<?php if (in_array(Yii::$app->user->identity->group->role, ['admin']) && isset($params['factory_id'])) { ?>
...
<?php } ?>
    ...
    <div class="form-group">
        <?= Select2::widget([
            'name' => 'type',
            'value' => $params['type'],
            'data' => [null => Yii::t('app', 'Все действия')] + ItalianProductStatsDays::getTypeLabel(),
            'options' => [
                'id' => 'type',
                'multiple' => false
            ]
