...
/**
 * Class SaleItalyStatsController
 *
 * @package frontend\modules\catalog\controllers
 */
class SaleItalyStatsController extends BaseController
{
    public $label = '';
    public $title = '';
    ...
    public function actionView($id)
    {
        ...
        $modelItalianProductStatsDays = new ItalianProductStatsDays();
        ...
        $stats = $modelItalianProductStatsDays->search($params);
